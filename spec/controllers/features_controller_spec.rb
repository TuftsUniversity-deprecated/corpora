  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved feature as @feature" do
        ...
        post :create, {:feature => { "type" => "invalid value" }}, valid_session
        assigns(:feature).should be_a_new(Feature)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested feature" do
        ...
        Feature.any_instance.should_receive(:update_attributes).with({ "type" => "" })
        put :update, {:id => feature.to_param, :feature => { "type" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the feature as @feature" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Feature.any_instance.stub(:save).and_return(false)
        put :update, {:id => feature.to_param, :feature => { "type" => "invalid value" }}, valid_session
        assigns(:feature).should eq(feature)
      end
